...
function getMovementFilter(moveId, durationSec = 5, targetW = 1280, targetH = 720) {
    ...
    const moves = {
        ...
        // Tilt Shift Safe: Replaced specific spatial enable with a vivid zoom + vignette simulation
        // The previous implementation used 'y' in 'enable' which is invalid and crashes FFmpeg.
